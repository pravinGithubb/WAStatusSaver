...
public interface DaoDeletedMsg {
    ...
    List<DeletedMsgTable> getDeletedRecord(boolean isDeleted);

    @Query("SELECT * FROM DeletedMsgTable GROUP BY username ORDER BY id DESC")
    ...
    @Query("SELECT * FROM DeletedMsgTable WHERE username =:username AND is_deleted = :is_deleted ORDER BY id ASC")
    List<DeletedMsgTable> getAllDeletedRecordByUsername(String username, Boolean is_deleted);

    @Query("SELECT * FROM DeletedMsgTable WHERE username =:username ORDER BY id ASC")
    List<DeletedMsgTable> getAllDeletedRecordByUsername(String username);
    ...
    @Query("DELETE FROM DeletedMsgTable WHERE username in (:usernameList)")
    void deleteRecordByUserName(List<String> usernameList);

    @Query("DELETE FROM DeletedMsgTable WHERE username = :usernameList")
    void deleteRecordByUserName(String usernameList);
